...
# Opcional: sobrescreve a URL do diretório mensal (calculada automaticamente se não definida)
# ENV RAIOS_BASE_URL=https://ftp.cptec.inpe.br/nowcasting/RAIOS/2026/03/
# ENV SNAPSHOT_WINDOW=12
